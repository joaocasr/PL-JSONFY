...
_lr_productions = [
  ...
  ('MLBASICBODY -> MLBC','MLBASICBODY',1,'p_MLBASICBODY','tomlex.py',455),
  ('MLBC -> CONTENTQUOTE MLBC','MLBC',2,'p_MLBC1','tomlex.py',459),
  ('MLBC -> <empty>','MLBC',0,'p_MLBC2','tomlex.py',463),
  ...
  ('MLBCONTENT -> MLBCHAR','MLBCONTENT',1,'p_MLBCONTENT1','tomlex.py',475),
  ('MLBCONTENT -> NEWLINE','MLBCONTENT',1,'p_MLBCONTENT2','tomlex.py',479),
  ('MLBCONTENT -> MLBESCAPEDNL','MLBCONTENT',1,'p_MLBCONTENT3','tomlex.py',483),
  ('MLBCONTENT -> TWODOT_SEP','MLBCONTENT',1,'p_MLBCONTENT4','tomlex.py',487),
  ('MLBCONTENT -> DOT_SEP','MLBCONTENT',1,'p_MLBCONTENT5','tomlex.py',491),
  ('MLBCONTENT -> VIRGULA','MLBCONTENT',1,'p_MLBCONTENT6','tomlex.py',495),
  ('MLBCHAR -> MLBUNESCAPED','MLBCHAR',1,'p_MLBCHAR1','tomlex.py',499),
  ('MLBCHAR -> ESCAPED','MLBCHAR',1,'p_MLBCHAR2','tomlex.py',503),
  ('MLBQUOTES -> ASPA','MLBQUOTES',1,'p_MLBQUOTES1','tomlex.py',507),
  ('MLBQUOTES -> DOUBLEASPA','MLBQUOTES',1,'p_MLBQUOTES2','tomlex.py',511),
  ('MLBQUOTES -> <empty>','MLBQUOTES',0,'p_MLBQUOTES3','tomlex.py',515),
  ('MLBUNESCAPED -> WHITESPACE','MLBUNESCAPED',1,'p_MLBUNESCAPED1','tomlex.py',519),
  ('MLBUNESCAPED -> CHAR','MLBUNESCAPED',1,'p_MLBUNESCAPED2','tomlex.py',523),
  ('MLBESCAPEDNL -> ESCAPE NEWLINE WHNL','MLBESCAPEDNL',3,'p_MLBESCAPEDNL','tomlex.py',527),
  ('WHNL -> SPACENEWLINE WHNL','WHNL',2,'p_WHNL1','tomlex.py',532),
  ('WHNL -> <empty>','WHNL',0,'p_WHNL2','tomlex.py',536),
  ('SPACENEWLINE -> WHITESPACE','SPACENEWLINE',1,'p_SPACENEWLINE1','tomlex.py',540),
  ('SPACENEWLINE -> NEWLINE','SPACENEWLINE',1,'p_SPACENEWLINE2','tomlex.py',544),
  ('LITERALSTRING -> APOSTROFE LCH APOSTROFE','LITERALSTRING',3,'p_LITERALSTRING','tomlex.py',548),
  ...
  ('LITERALCHAR -> WHITESPACE','LITERALCHAR',1,'p_LITERALCHAR3','tomlex.py',569),
  ('LITERALCHAR -> TWODOT_SEP','LITERALCHAR',1,'p_LITERALCHAR4','tomlex.py',573),
  ('LITERALCHAR -> ASPA','LITERALCHAR',1,'p_LITERALCHAR5','tomlex.py',577),
  ('LITERALCHAR -> ESCAPE','LITERALCHAR',1,'p_LITERALCHAR6','tomlex.py',581),
  ('MLLITERALSTRING -> TRIPLEAPOSTROFE NLR MLLITERALBODY TRIPLEAPOSTROFE','MLLITERALSTRING',4,'p_MLLITERALSTRING','tomlex.py',585),
  ('NLR -> NEWLINE','NLR',1,'p_NLR1','tomlex.py',589),
  ('NLR -> <empty>','NLR',0,'p_NLR2','tomlex.py',593),
  ('MLLITERALBODY -> MLLC','MLLITERALBODY',1,'p_MLLITERALBODY','tomlex.py',597),
  ('MLLC -> MLLCONTENTQUOTES MLLC','MLLC',2,'p_MLLC1','tomlex.py',601),
  ('MLLCONTENTQUOTES -> MLLCONTENT','MLLCONTENTQUOTES',1,'p_MLLCONTENTQUOTES1','tomlex.py',605),
  ('MLLCONTENTQUOTES -> MLLQUOTES','MLLCONTENTQUOTES',1,'p_MLLCONTENTQUOTES2','tomlex.py',609),
  ('MLLC -> <empty>','MLLC',0,'p_MLLC2','tomlex.py',613),
  ('MLLCONTENT -> MLLCHAR','MLLCONTENT',1,'p_MLLCONTENT1','tomlex.py',617),
  ('MLLCONTENT -> NEWLINE','MLLCONTENT',1,'p_MLLCONTENT2','tomlex.py',621),
  ('MLLCHAR -> CHAR','MLLCHAR',1,'p_MLLCHAR1','tomlex.py',625),
  ('MLLCHAR -> DOT_SEP','MLLCHAR',1,'p_MLLCHAR2','tomlex.py',629),
  ('MLLCHAR -> WHITESPACE','MLLCHAR',1,'p_MLLCHAR3','tomlex.py',633),
  ('MLLCHAR -> VIRGULA','MLLCHAR',1,'p_MLLCHAR4','tomlex.py',637),
  ('MLLQUOTES -> DOUBLEAPOSTROFE','MLLQUOTES',1,'p_MLLQUOTES1','tomlex.py',641),
  ('MLLQUOTES -> APOSTROFE','MLLQUOTES',1,'p_MLLQUOTES2','tomlex.py',645),
  ('MLLQUOTES -> <empty>','MLLQUOTES',0,'p_MLLQUOTES3','tomlex.py',653),
  ('ARRAY -> APR ARRAYVALUES WSCOMMENTNEWLINE FPR','ARRAY',4,'p_ARRAY','tomlex.py',657),
  ('ARRAYVALUES -> <empty>','ARRAYVALUES',0,'p_ARRAYVALUES1','tomlex.py',661),
  ('ARRAYVALUES -> WSCOMMENTNEWLINE VALUE WSCOMMENTNEWLINE ARRAYCONTEUDO','ARRAYVALUES',4,'p_ARRAYVALUES2','tomlex.py',665),
  ('ARRAYCONTEUDO -> <empty>','ARRAYCONTEUDO',0,'p_ARRAYVALUES3','tomlex.py',671),
  ('ARRAYCONTEUDO -> WSCOMMENTNEWLINE VIRGULA ARRAYVALUES','ARRAYCONTEUDO',3,'p_ARRAYVALUES4','tomlex.py',675),
  ('WSCOMMENTNEWLINE -> <empty>','WSCOMMENTNEWLINE',0,'p_WSCOMMENTNEWLINE1','tomlex.py',691),
  ('WSCOMMENTNEWLINE -> INNERCOMMENT WSCOMMENTNEWLINE','WSCOMMENTNEWLINE',2,'p_WSCOMMENTNEWLINE2','tomlex.py',696),
  ('INNERCOMMENT -> WHITESPACE','INNERCOMMENT',1,'p_INNERCOMMENT1','tomlex.py',699),
  ('INNERCOMMENT -> COMMENTOUNAO NEWLINE','INNERCOMMENT',2,'p_INNERCOMMENT2','tomlex.py',702),
  ('INNERCOMMENT -> NEWLINE','INNERCOMMENT',1,'p_INNERCOMMENT3','tomlex.py',705),
  ('COMMENTOUNAO -> COMMENT','COMMENTOUNAO',1,'p_COMMENTOUNAO1','tomlex.py',708),
  ('COMMENTOUNAO -> <empty>','COMMENTOUNAO',0,'p_COMMENTOUNAO2','tomlex.py',712),
  ('TABLE -> STDTABLE','TABLE',1,'p_TABLE1','tomlex.py',715),
  ('TABLE -> TABLEARRAY','TABLE',1,'p_TABLE2','tomlex.py',719),
  ('STDTABLE -> APR KEY FPR','STDTABLE',3,'p_STDTABLE','tomlex.py',723),
  ('INLINETABLE -> ACH FCH','INLINETABLE',2,'p_INLINETABLE','tomlex.py',731),
  ('INLINETABLE -> ACH INLINETABLEWS INLINEKVALUE INLINETABLEWS FCH','INLINETABLE',5,'p_INLINETABLE2','tomlex.py',735),
  ('INLINETABLEWS -> <empty>','INLINETABLEWS',0,'p_INLINETABLEWS1','tomlex.py',739),
  ('INLINETABLEWS -> WHITESPACE','INLINETABLEWS',1,'p_INLINETABLEWS2','tomlex.py',742),
  ('INLINEKVALUE -> INLINEKVALUE INLINETABLEWS VIRGULA INLINETABLEWS KVALUE','INLINEKVALUE',5,'p_INLINEKVALUE','tomlex.py',745),
  ('INLINEKVALUE -> KVALUE','INLINEKVALUE',1,'p_INLINEKVALUE2','tomlex.py',751),
  ('TABLEARRAY -> ATO KEY ATC','TABLEARRAY',3,'p_TABLEARRAY1','tomlex.py',755),
]
